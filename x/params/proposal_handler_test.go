	...
	testCases := []struct {
		...
		},
		{
			...
			testProposal(proposal.ParamChange{
				...
				Value:    `{"min_deposit": [{"denom": "uatom","amount": "64000000"}], "max_deposit_period": "172800000000000", "min_expedited_deposit": [{"denom": "uatom","amount": "74000000"}]}`,
			}),
			func() {
				...
				suite.Require().Equal(govv1.DepositParams{
					...
					MinExpeditedDeposit: sdk.NewCoins(sdk.NewCoin("uatom", sdk.NewInt(74000000))),
				}, depositParams)
			},
			false,
		},
