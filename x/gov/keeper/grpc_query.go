...
func (q legacyQueryServer) Params(c context.Context, req *v1beta1.QueryParamsRequest) (*v1beta1.QueryParamsResponse, error) {
	...
	if resp.DepositParams != nil {
		...
		response.DepositParams = v1beta1.NewDepositParams(minDeposit, resp.DepositParams.MinExpeditedDeposit, *resp.DepositParams.MaxDepositPeriod)
	}
	...
	if resp.TallyParams != nil {
		...
		expeditedQuorum, err := sdk.NewDecFromStr(resp.TallyParams.ExpeditedQuorum)
		...
		response.TallyParams = v1beta1.NewTallyParams(quorum, expeditedQuorum, threshold, expeditedThreshold, vetoThreshold)
	}
