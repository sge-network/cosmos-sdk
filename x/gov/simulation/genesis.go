...
// GenDepositPeriod returns randomized DepositParamsDepositPeriod
...
// GenVotingPeriod returns randomized VotingParamsVotingPeriod
...
// GenVeto returns randomized TallyParamsVeto
...
func RandomizedGenState(simState *module.SimulationState) {
	...
	var expeditedVotingThreshold sdk.Dec
	simState.AppParams.GetOrGenerate(
		simState.Cdc, ExpeditedThreshold, &expeditedVotingThreshold, simState.Rand,
		func(r *rand.Rand) { expeditedVotingThreshold = GenExpeditedThreshold(r) },
	)
